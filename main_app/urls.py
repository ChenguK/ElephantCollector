...
urlpatterns = [
    ...
    path('elephants/', views.ElephantList.as_view(), name='elephants_list'),
    ...
    path('elephants/<int:elephant_id>/<int:photo_id>/photos_delete', views.photos_delete, name='photos_delete'),
